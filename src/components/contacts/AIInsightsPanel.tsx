...
export const AIInsightsPanel: React.FC<AIInsightsPanelProps> = ({ contact }) => {
  ...
  const handleGenerateInsights = async () => {
    try {
      await generateAIInsights([contact]);
    } catch (error) {
  ...
  // Use real insights from AI Context or fallback to sample data
  const insights = contactInsights || generateInsights(contact);
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <span>{isProcessing ? 'Analyzing...' : 'Refresh Insights'}</span>
          </ModernButton>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <GlassCard className="p-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-2xl font-bold text-gray-900">{contact.aiScore || 0}</p>
        ...
        <GlassCard className="p-8">
          <div className="flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Advanced intelligence engine coming soon</p>
              <p className="text-sm text-gray-500">Cross-component correlation analysis</p>
            </div>
          </div>
        </GlassCard>
      )}
        ...
        <GlassCard className="p-8">
          <div className="flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-4">Smart recommendations coming soon</p>
