...
export const ActivityFeed: React.FC = () => {
  const { activities, addActivity } = useTaskStore();
  ...
  const generateAIActivityInsights = async () => {
    ...
    try {
      ...
      // Add AI-generated activities to the feed
      insights.forEach(insight => {
        addActivity({
          ...
          metadata: { confidence: insight.confidence, actionable: insight.actionable }
        });
      });
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <button
              onClick={generateAIActivityInsights}
        ...
        <div className="flex items-center space-x-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              {Object.keys(activityIcons).slice(0, 10).map((type) => (
                <DropdownMenuCheckboxItem
                  key={type}
